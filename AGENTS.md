...
- git remote add origin https://github.com/fonn-claw/skillforge.git
- git push -u origin main
- npx vercel --yes && npx vercel domains add skillforge.demos.fonnit.com && npx vercel --prod
- Set env vars: DATABASE_URL, SESSION_SECRET

## On Completion
When completely finished, run:
openclaw system event --text "BUILD COMPLETE: SkillForge — Learning Gamification & Skill Progression" --mode now
